...
namespace EADDreamCarProject.Controllers
{
    public class ShowroomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShowroomID,ShowroomName,ShowroomCity,ShowroomAddress,ShowroomContact,ShowroomEmail")] Showroom showroom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShowroomID,ShowroomName,ShowroomCity,ShowroomAddress,ShowroomContact,ShowroomEmail")] Showroom showroom)
        {
            if (ModelState.IsValid)
            {
